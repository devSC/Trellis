...
| [Guru Overlay Gates](./guru-overlay-gates.md) | Guru delivery routes and budgets, risk/start gates, evidence reuse, reversible Custom lifecycle, and commit-gate fail-closed behavior | Done |
---
...
- Editing Guru overlay policy/gate scripts, route budgets, task-local gate contracts, reversible apply lifecycle, or adversarial review config → [guru-overlay-gates.md](./guru-overlay-gates.md)
